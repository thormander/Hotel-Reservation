...
class Login_Guest {
    ...
    public void testGuestSignIn_SuccessfulSignIn() throws Exception {
        ...
        String url = "http://localhost:8080/hotelMain/accountHandler?username=testguest@gmail.com&password=test&accountType=guest";
        ...
        assertTrue(responseBody.contains("Welcome testguest!"));
    }    
